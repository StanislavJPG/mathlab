...
from forum.views import ForumBaseView, forum_topics, QuestionCreationView, QuestionView
...
urlpatterns = [
    ...
    path('forum/question/<int:q_id>/<str:title>/', QuestionView.as_view({'post': 'create_comment'}),
         name='forum-q'),
