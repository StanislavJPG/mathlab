...
class TestForum(APITestCase):
    def setUp(self):
        ...
        self.new_user = CustomUser.objects.create(
        ...
        self.new_post = Post.objects.create(
            title="test_title", content="test_content", user=self.new_user
        )
    ...
    def test_create_comment(self):
        url = reverse(
            "forum-q", kwargs={"q_id": self.new_post.id, "title": self.new_post.title}
        )
    ...
    def test_create_post_rate(self):
        url = reverse(
            "forum-q-rate",
            kwargs={"q_id": self.new_post.id, "title": self.new_post.title},
        )
    ...
    def test_post_search(self):
        ...
        data = {"page": 1, "search_pattern": "test_title"}
