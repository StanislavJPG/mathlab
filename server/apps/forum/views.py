...
class ForumBaseView(APIView):
    ...
    def get(self, request):
        ...
        if order_by:
            ...
            return render(request, "forum/forum_base_page.html", context=context)
...
class QuestionCreationView(APIView):
    ...
    def get(self, request):
        ...
        return render(
            request,
            "forum/forum_add_question_page.html",
            context={
...
class QuestionView(viewsets.ViewSet):
    ...
    def get(self, request, q_id: int, title: str):
        ...
        if not cached_data:
            ...
            context = cached_data
        return render(request, "forum/forum_question_page.html", context=context)
