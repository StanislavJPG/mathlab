# Generated by Django 5.1.11 on 2025-08-30 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'max_time_to_solve',
                    models.DurationField(blank=True, default=datetime.timedelta(0), verbose_name='max time to solve'),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_at', models.DateTimeField(auto_now=True, null=True)),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('solved_by_name', models.CharField(blank=True, max_length=255)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'math_expression',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game_area.mathexpression'),
                ),
                (
            ...
            options={
                'verbose_name': 'Math solved expressions',
        ...
        migrations.AddField(
            ...
            name='solved_expressions',
            field=models.ManyToManyField(
                blank=True, through='game_area.MathSolvedExpressions', to='game_area.mathexpression'
            ),
        ),
        migrations.CreateModel(
