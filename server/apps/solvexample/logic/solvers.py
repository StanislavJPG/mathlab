# TODO: SPLIT THIS MODULE BY 3 BLOCKS (views)
...
def equations(request: Request):
    ...
    return render(request=request, template_name="equations.html", context=context)
...
def percents(request: Request):
    ...
    return render(request=request, template_name="percents.html", context=context)
...
def matrix(request: Request):
    ...
    return render(request=request, template_name="matrix.html", context=context)
